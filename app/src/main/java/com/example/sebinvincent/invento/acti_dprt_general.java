...
public class acti_dprt_general extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dprt_general);
        menu=(ImageView)findViewById(R.id.genaral_menu);

        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.Container,new frag_general_events());
