...
public class acti_google_signin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acti_google_signin);
        ...
        mGoogleApiClient = new GoogleApiClient.Builder( this)
                .enableAutoManage(  this /* Fragment Activity */ , new GoogleApiClient.OnConnectionFailedListener(){
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(acti_google_signin.this,"Something went wrong", Toast.LENGTH_SHORT).show();
                    }
                })
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(acti_google_signin.this, "Authentication Failed", Toast.LENGTH_SHORT).show();
                            //updateUI(null);
                        }
