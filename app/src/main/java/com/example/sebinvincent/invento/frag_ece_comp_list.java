...
public class frag_ece_comp_list extends Fragment {

    private static final String url_data="https://inventogec.org/api/v1/events/ece/com/?format=json";

    private RecyclerView recyclerView;
    private Myadapter adapter;

    public frag_ece_comp_list() {
    ...
    private  void loadRecyclerviewData(){
        ...
        if(!isNetworkConnected()){
            ...
            ece_comp_array array= new ece_comp_array();
