 ...
 */
public class frag_it_comp_list extends Fragment {

    private static final String url_data="https://inventogec.org/api/v1/events/it/com/?format=json";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view;
        ...
        view=inflater.inflate(R.layout.frag_it_comp_list, container, false);
    ...
    private  void loadRecyclerviewData(){
        ...
        if(!isNetworkConnected()){
            ...
            it_comp_array array= new it_comp_array();
