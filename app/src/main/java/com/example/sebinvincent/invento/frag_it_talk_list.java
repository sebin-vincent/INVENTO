...
public class frag_it_talk_list extends Fragment {

    private static final String url_data="https://inventogec.org/api/v1/events/it/sho/?format=json";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.frag_it_talk_list, container, false);
    ...
    private  void loadRecyclerviewData(){
        ...
        if(!isNetworkConnected()){
            ...
            it_talk_array array= new it_talk_array();
