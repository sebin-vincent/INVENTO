    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(),"Welcome to Cse Virus",Toast.LENGTH_LONG).show();
        ...
        it.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(),"Welcome to Itianz",Toast.LENGTH_LONG).show();
        ...
        ece.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(),"Welcome to Terror Ec",Toast.LENGTH_LONG).show();
        ...
        mech.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(),"Welcome to Royal Mech",Toast.LENGTH_LONG).show();
        ...
        eee.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(),"Welcome to Power Eee",Toast.LENGTH_LONG).show();
        ...
        general.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(),"Welcome to Generals",Toast.LENGTH_LONG).show();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(),"Welcome Home",Toast.LENGTH_LONG).show();
